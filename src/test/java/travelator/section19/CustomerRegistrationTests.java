...
public class CustomerRegistrationTests {
    ...
    @Test
    void adds_a_customer_when_not_excluded() throws DuplicateException, ExcludedException {
    ...
    @Test
    void throws_DuplicateException_when_email_address_exists() {
    ...
    @Test
    void throws_ExcludedException_when_excluded() {
